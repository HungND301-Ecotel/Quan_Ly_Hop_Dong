// features/main/contract/expired/page.tsx
import {
  DataTable,
  DataTableContent,
...
export function ContractExpiredPage() {
  const { setAction } = useMainLayoutContext();

  const ContractExpiredList = useCallback(async () => {
    return contractService.getContractSoonExpired();
  }, []);

  const dataTable = useDataTable({
    columns: ContractColumns,
    service: ContractExpiredList,
    keys: ['contract-expired'],
  });
