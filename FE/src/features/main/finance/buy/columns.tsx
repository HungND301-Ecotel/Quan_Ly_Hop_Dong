...
import { ContractLiquidation } from '../../contract/liquidation/LiquidationContract';
import { ContractPause } from '../../contract/all/components/ContractPause';
import { ContractResume } from '../../contract/all/components/ContractResume';
import { ContractArchive } from '../../contract/all/components/ChangeArchive';
import { ContractRenew } from '../../contract/all/components/ContractRenew';

export const EconomicContractColumns: ColumnDef<Contract>[] = [
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className='flex items-center justify-center gap-1'>
          ...
          <EconomicContractDetail contract={row.original} callback={refresh} />
        </div>
      );
    },
  },
