...
public class Level1Code : AuditableEntity<Guid>
{
    ...
    // Constructor
    public static Level1Code Create(string code, Guid contractTypeId, string? description = null)
    {
    ...
    public void Update(string code, Guid contractTypeId, string? description = null)
    {
        Code = code;
        ContractTypeId = contractTypeId;
        Description = description;
