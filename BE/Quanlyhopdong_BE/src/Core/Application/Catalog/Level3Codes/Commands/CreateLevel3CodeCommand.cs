...
public record CreateLevel3CodeCommand(string Code, Guid Level1CodeId, Guid? Level2CodeId = null, string? Description = null) : IRequest<Guid>;
...
public class CreateLevel3CodeCommandHandler(ILevel3CodeService level3CodeService) : IRequestHandler<CreateLevel3CodeCommand, Guid>
{
    ...
    {
        return await level3CodeService.CreateAsync(request.Code, request.Level1CodeId, request.Level2CodeId, request.Description);
    }
}
