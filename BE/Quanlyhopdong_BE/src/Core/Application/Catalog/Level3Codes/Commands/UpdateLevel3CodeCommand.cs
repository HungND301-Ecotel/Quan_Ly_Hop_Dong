...
public record UpdateLevel3CodeCommand(Guid Id, string Code, Guid Level1CodeId, Guid? Level2CodeId = null, string? Description = null) : IRequest<bool>;
...
public class UpdateLevel3CodeCommandHandler(ILevel3CodeService level3CodeService) : IRequestHandler<UpdateLevel3CodeCommand, bool>
{
    ...
    {
        return await level3CodeService.UpdateAsync(request.Id, request.Code, request.Level1CodeId, request.Level2CodeId, request.Description);
    }
}
