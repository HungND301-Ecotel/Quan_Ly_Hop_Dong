...
public record class DeleteContractRegisterListCommand(List<Guid> DeleteIds) : IRequest<bool>;

public class DeleteContractRegisterListCommandHandler(IUnitOfWork _unitOfWork) : IRequestHandler<DeleteContractRegisterListCommand, bool>
{
    ...
    public async Task<bool> Handle(DeleteContractRegisterListCommand request, CancellationToken cancellationToken)
    {
