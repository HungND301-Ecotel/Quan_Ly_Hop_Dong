...
public record CreateLevel1CodeCommand(string Code, Guid ContractTypeId, Guid? ContractRegisterId, string? Description = null) : IRequest<Guid>;
...
public class CreateLevel1CodeCommandHandler(ILevel1CodeService level1CodeService) : IRequestHandler<CreateLevel1CodeCommand, Guid>
{
    ...
    {
        return await level1CodeService.CreateAsync(request.Code, request.ContractTypeId, request.ContractRegisterId, request.Description);
    }
}
