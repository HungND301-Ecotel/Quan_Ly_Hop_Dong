...
public record UpdateLevel1CodeCommand(Guid Id, string Code, Guid ContractTypeId, string? Description = null) : IRequest<bool>;
...
public class UpdateLevel1CodeCommandHandler(ILevel1CodeService level1CodeService) : IRequestHandler<UpdateLevel1CodeCommand, bool>
{
    ...
    {
        return await level1CodeService.UpdateAsync(request.Id, request.Code, request.ContractTypeId, request.Description);
    }
}
